...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/smartbear/IntegrationTestAPIMan/1.0.0/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/smartbear/IntegrationTestAPIMan/1.0.0/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/smartbear/IntegrationTestAPIMan/1.0.0/pet/findByStatus")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/smartbear/IntegrationTestAPIMan/1.0.0/pet/findByTags")]
        [ValidateModelState]
        ...
        /// <response code="200">successful operation</response>
        [HttpPost]
        [Route("/smartbear/IntegrationTestAPIMan/1.0.0/pet/{petId}/uploadImage")]
        [ValidateModelState]
