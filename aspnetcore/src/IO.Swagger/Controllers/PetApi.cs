...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/AmandasOrg/ThisIsMyAPIName/1.0.0/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/AmandasOrg/ThisIsMyAPIName/1.0.0/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/AmandasOrg/ThisIsMyAPIName/1.0.0/pet/findByStatus")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/AmandasOrg/ThisIsMyAPIName/1.0.0/pet/findByTags")]
        [ValidateModelState]
        ...
        /// <response code="200">successful operation</response>
        [HttpPost]
        [Route("/AmandasOrg/ThisIsMyAPIName/1.0.0/pet/{petId}/uploadImage")]
        [ValidateModelState]
