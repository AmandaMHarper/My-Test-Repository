...
{ 
    ...
    { 
        ...
        [HttpDelete]
        [Route("/AmandasOrg/ThisIsMyAPIName/1.0.0/store/order/{orderId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/AmandasOrg/ThisIsMyAPIName/1.0.0/store/inventory")]
        ...
        [HttpPost]
        [Route("/AmandasOrg/ThisIsMyAPIName/1.0.0/store/order")]
        [ValidateModelState]
